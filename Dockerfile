...
RUN apt-get update
RUN apt-get install -y python3 python3-dev python3-pip python-setuptools sqlite3 libsqlite3-dev libxml2-dev libxslt-dev libjpeg-dev zlib1g-dev libpng12-dev
